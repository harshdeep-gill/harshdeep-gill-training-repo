...
// Softrip Middleware.
define( 'QUARK_SOFTRIP_BASE_URL', env( 'QUARK_SOFTRIP_BASE_URL' ) );
define( 'QUARK_SOFTRIP_USERNAME', env( 'QUARK_SOFTRIP_USERNAME' ) );
define( 'QUARK_SOFTRIP_PASSWORD', env( 'QUARK_SOFTRIP_PASSWORD' ) );
