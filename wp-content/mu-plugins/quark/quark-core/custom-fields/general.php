...
if ( function_exists( 'acf_add_local_field_group' ) ) {
	acf_add_local_field_group(
		[
			...
			'fields'                => [
				[
					'key'               => 'field_92f587b9a2c71',
					'label'             => 'Disable Softrip Sync',
					'name'              => 'disable_softrip_sync',
					'aria-label'        => '',
					'type'              => 'true_false',
					'instructions'      => '',
					'required'          => 0,
				...
				[
					'key'               => 'field_9134f587b9a2c71',
					'label'             => 'Disable Ingestor Push',
					'name'              => 'disable_ingestor_push',
					'aria-label'        => '',
					'type'              => 'true_false',
					'instructions'      => '',
					'required'          => 0,
