 ...
 *  data-entity-uuid="b3a11cbc-53a9-419d-b9b5-2497ac0ba2ba" data-align="center" data-caption="caption text">.
 *
 ...
 * @return string
 */
function get_drupal_block_data( array $block = [] ): string {
	// WordPress block.
	$wp_block = '';
	...
	switch ( $block['type'] ) {
		...
		case 'hero_default':
			$wp_block = convert_paragraph_hero_default( $block );
			break;

		// Convert op_video block.
		case 'hero_banner':
			$wp_block = convert_paragraph_hero_banner( $block );
			break;
	}
 ...
 * @return string
 */
function convert_paragraph_hero_default( array $block = [] ): string {
 ...
 * @return string
 */
function convert_paragraph_hero_banner( array $block = [] ): string {
	// Get database connection.
	$drupal_database = get_database();
