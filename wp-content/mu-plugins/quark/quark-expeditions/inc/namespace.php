...
/**
 * Organise Destination Terms.
 *
 * @param array<int> $terms Terms.
 *
 * @return array{}|array<int, array<string, array<int, WP_Term>|WP_Term>>
 */
function organise_desination_terms( array $terms = [] ): array {
	// Organise terms.
	$organised_terms = [];
	...
	foreach ( $terms as $term ) {
		// Get the term.
		$term = get_term( $term, DESTINATION_TAXONOMY );
