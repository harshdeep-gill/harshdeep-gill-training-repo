...
class Test_Update_Departures extends Softrip_TestCase {
    ...
    public function test_update_departures(): void {
        ...
        $itinerary_id = $this->factory()->post->create( [ 'post_type' => ITINERARY_POST_TYPE, 'meta_input' => [
        ...
        $itinerary_id_2 = $this->factory()->post->create( [ 'post_type' => ITINERARY_POST_TYPE, 'meta_input' => [
            'softrip_package_code' => $pqo_softrip_package_code,
        ], ] );
        ...
        $ship_id_omx = $this->factory()->post->create( [ 'post_type' => SHIP_POST_TYPE, 'meta_input' => [
            'ship_code' => 'OMX',
        ], ] );
        ...
        $ship_id_omi = $this->factory()->post->create( [ 'post_type' => SHIP_POST_TYPE, 'meta_input' => [
            'ship_code' => 'OMI',
        ], ] );
