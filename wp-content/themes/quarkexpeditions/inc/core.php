...
function register_styles(): void {
	...
	wp_register_style( 'tp-modal', get_template_directory_uri() . '/dist/vendor/tpmodalelement.css', [], $assets_version );
...
function register_scripts(): void {
	...
	wp_register_script( 'tp-modal', get_template_directory_uri() . '/dist/vendor/tpmodalelement.js', [], $assets_version, true );
