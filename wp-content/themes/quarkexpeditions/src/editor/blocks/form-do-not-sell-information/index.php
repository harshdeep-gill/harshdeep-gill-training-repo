<?php
/**
 * Block: Form - Do Not Sell Information
 *
 * @package quark
 */

namespace Quark\Theme\Blocks\FormDoNotSellInformation;

use WP_Block;

const COMPONENT  = 'form-do-not-sell';
const BLOCK_NAME = 'quark/form-do-not-sell-information';
