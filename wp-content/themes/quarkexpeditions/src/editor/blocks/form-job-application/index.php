<?php
/**
 * Block: Form - Job Application
 *
 * @package quark
 */

namespace Quark\Theme\Blocks\FormJobApplication;
...
const COMPONENT  = 'form-job-application';
const BLOCK_NAME = 'quark/form-job-application';
