...
/**
 * ThumbnailCardsSlider Class.
 */
export default class ThumbnailCardsSlider extends HTMLElement {
	/**
	 * Properties.
	 */
	...
	constructor() {
		...
		// Elements.
		this.slider = this.querySelector( '.thumbnail-cards__slider' );
		this.cards = this.querySelectorAll( '.thumbnail-cards__card' );
...
// Define element.
customElements.define( 'quark-thumbnail-cards-slider', ThumbnailCardsSlider );
