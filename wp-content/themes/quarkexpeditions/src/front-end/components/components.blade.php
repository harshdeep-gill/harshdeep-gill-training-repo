				...
				<div style="display: flex; ">
					<x-form.field :validation="[ 'required' ]">
						<x-form.inline-dropdown label="Currency">
							...
							<x-form.option value="CAD" label="$ CAD" selected="yes">$ CAD</x-form.option>
					...
					<x-form.field>
						<x-form.inline-dropdown label="Sort">
							<x-form.option value="date-now" label="Date (upcoming to later)">Date (upcoming to later)</x-form.option>
							<x-form.option value="date-later" label="Date (later to upcoming)" selected="yes">Date (later to upcoming)</x-form.option>
