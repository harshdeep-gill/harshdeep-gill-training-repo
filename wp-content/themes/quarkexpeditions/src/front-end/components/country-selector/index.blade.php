...
<x-form.field :validation="[ 'required' ]" class="{{ $class_prefix . '__country' }}">
...
@foreach ( $states as $country_code => $country_states )
	<x-form.field :validation="[ 'required' ]" data-country="{{ $country_code }}" class="{{ $class_prefix . '__state' }}" data-name="fields[State_Code__c]">
