...
export class LoadMore extends HTMLElement {
	...
	scrollToNewCards( page: number ): void {
		 ...
		 * 4: number of cards per page - partials/book-departure-ships.php.
		...
		const focusCard = document.querySelector( `.book-departures-ships__results .departure-cards__card:nth-child(${ focusCardIndex })` );
