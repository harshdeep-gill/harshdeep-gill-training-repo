		...
		@if ( empty( $thank_you_page ) )
			<div class="inquiry-form__thank-you">
				...
				<div class="inquiry-form__thank-you-text">
					<h4 class="inquiry-form__thank-you-text-heading">{{ __( 'Thank you', 'qrk' ) }}</h4>
					<p class="inquiry-form__thank-you-text-body">{{ __( 'A Quark Expeditions Polar Travel Advisor will be in touch with you shortly.', 'qrk' ) }}</p>
				</div>
			</div>
		@endif
	</quark-inquiry-form-modal>
