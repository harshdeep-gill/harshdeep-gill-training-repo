			...
			<div class="form-two-step__content">
				...
				<x-modal.body>
					...
					<x-form.row>
						...
						<x-form.field :validation="[ 'required' ]" data-country="AU" class="form-two-step__state" data-name="fields[State_Code__c]">
						...
						<x-form.field :validation="[ 'required' ]" data-country="US" class="form-two-step__state" data-name="fields[State_Code__c]">
							<x-form.select label="State/Province">
								<option value="">- Select -</option>
						...
						<x-form.field :validation="[ 'required' ]" data-country="CA" class="form-two-step__state" data-name="fields[State_Code__c]">
							<x-form.select label="State/Province">
								<option value="">- Select -</option>
